...
let dimensions = _.map(defo.dimensions, (item) => {
    ...
    if (item.id === 'status_id') item.checked = true
    if (item.id === 'customer') item.checked = true
    if (item.id === 'order_type') item.checked = true
    if (item.id === 'payment_type') item.checked = true
    if (item.id === 'dealer') item.checked = true
