...
@section('panel-body')
    <div class="row reports">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="#expense-report">

            <div class="report_filter_area">

                {!! Form::open(['url' => '', 'class' => 'report_filter_form', 'data-url' => action('ReportsController@ajaxReport', ['report_type' => 'expenses']) ]) !!}
                        ...
                        <ul class="nav nav-pills pull-right" role="tablist">
                            ...
                            <li role="presentation pull-right" class="dropdown select-dimensions">
                                ...
                                <ul class="dropdown-menu select-dimension-list" role="menu"
                                    ...
                                    <?php foreach ($params['rules']['expense_report']['dimensions'] as $dimension_id => $dimension): ?>
                            ...
                            <li role="presentation pull-right" class="dropdown select-conditions">
                                ...
                                <ul class="dropdown-menu select-condition-list" role="menu"
                                    ...
                                    <?php foreach ($params['rules']['expense_report']['conditions'] as $condition_id => $condition): ?>
                                    <li role="presentation"
...
@section('footer-scripts')
    ...
    <script type="text/javascript" charset="utf-8">
        (function ($, _) {
            ...
            expenseReport.data.form['report_type'] = 'expenses';
            expenseReport.data.form['_token'] = $('input[name="_token"]').val();
            expenseReport.data.rules = {!! json_encode($params['rules']['expense_report']) !!};
            expenseReport.data.rules['date_params'] = date;

            var Report = $('#expense-report').dynamicReport(expenseReport);
            Report.initialize();
